  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Contact TechVid Innovations in Madhapur, Hyderabad. Call +91 92475 90748 or email admin@techvidin.com / hr@techvidin.com. Follow us on Instagram and WhatsApp for instant support."
        />

        <meta
          name="keywords"
          content="contact TechVid, education institute Hyderabad, Madhapur coaching center, online education contact, tech courses enquiry"
        />

        <link
          rel="canonical"
          href="https://www.techvidin.com/contact"
        />

        <meta
          property="og:title"
          content="Contact TechVid Innovations"
        />

        <meta
          property="og:description"
          content="Get in touch with us in Hyderabad. Call, email, or visit our Madhapur office."
        />

        <meta
          property="og:url"
          content="https://www.techvidin.com/contact"
        />
      </Helmet>
      ...
      <div>
                ...
                const CardContent = (
                  <Card hover>
                    <div className="text-center">
                      ...
                      <div
                        className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-light mb-4 ${card.color}`}
                      >
                        <Icon size={28} />
                      </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-dark-light mb-6">
                    Reach out to us directly through WhatsApp, follow us on
                    Instagram, or connect with us on LinkedIn.
                  </p>
                ...
                <Card>
                  ...
                  <div className="space-y-2 text-dark-light">
                    ...
                    <p>
                      ...
                      {contactInfo.officeHours.weekdayTime}
                    </p>
                ...
                <Card>
                  ...
                  <div className="space-y-2">
                    ...
                    <a
                      href="https://techvid-blogs.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block text-primary hover:text-primary-600 transition-colors"
                    >
        ...
        <section className="h-96">
          ...
          <iframe
            src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.2!2d${contactInfo.location
              .split('=')[1]
              .split(',')[1]}!3d${contactInfo.location
              .split('=')[1]
              .split(',')[0]}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI2JzEyLjEiTiA3OMKwMjMnMzguNCJF!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin`}
            width="100%"
            height="100%"
            style={{ border: 0 }}
            allowFullScreen=""
